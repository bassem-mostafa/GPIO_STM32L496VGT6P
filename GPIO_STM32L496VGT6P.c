...
void HAL_GPIO_EXTI_Callback( uint16_t GPIO_Pin )
{
    for ( GPIO_STM32L496VGT6P_t GPIO_x = GPIO_STM32L496VGT6P_1; GPIO_x < GPIO_STM32L496VGT6P_Count; ++GPIO_x )
    {
        ...
        if ( Context->InitType.Pin == GPIO_Pin
...
static GPIO_STM32L496VGT6P_Status_t GPIO_STM32L496VGT6P_Instance_Write( GPIO_STM32L496VGT6P_Instance_t * Instance, GPIO_STM32L496VGT6P_Value_t Value )
{
    GPIO_STM32L496VGT6P_Status_t Status = GPIO_STM32L496VGT6P_Status_Error;
    ...
    do
    {
        ...
        {
            Status = GPIO_STM32L496VGT6P_Status_Error;
            break;
        }

        if ( Instance->Context->GPIOx != NULL )
        {
            HAL_GPIO_WritePin( Instance->Context->GPIOx, Instance->Context->InitType.Pin, Value );
        }

        Status = GPIO_STM32L496VGT6P_Status_Success;
    }
    while ( 0 );
...
static GPIO_STM32L496VGT6P_Status_t GPIO_STM32L496VGT6P_Instance_Read( GPIO_STM32L496VGT6P_Instance_t * Instance, GPIO_STM32L496VGT6P_Value_t * Value )
{
    ...
    do
    {
        ...
        if ( Instance->Context->GPIOx != NULL )
        {
            *Value = HAL_GPIO_ReadPin( Instance->Context->GPIOx, Instance->Context->InitType.Pin );
        }
    ...
    do
    {
        ...
        switch ( Mode )
        {
            case GPIO_STM32L496VGT6P_Mode_Input:
                Instance->Context->InitType.Mode = GPIO_MODE_INPUT;
                break;

            case GPIO_STM32L496VGT6P_Mode_Output:
                Instance->Context->InitType.Mode = GPIO_MODE_OUTPUT_PP;
                break;

            case GPIO_STM32L496VGT6P_Mode_OutputOpenDrain:
                Instance->Context->InitType.Mode = GPIO_MODE_OUTPUT_OD;
                break;

            case GPIO_STM32L496VGT6P_Mode_Interrupt:
                Instance->Context->InitType.Mode = GPIO_MODE_IT_RISING_FALLING;
                break;

            case GPIO_STM32L496VGT6P_Mode_InterruptRising:
                Instance->Context->InitType.Mode = GPIO_MODE_IT_RISING;
                break;

            case GPIO_STM32L496VGT6P_Mode_InterruptFalling:
                Instance->Context->InitType.Mode = GPIO_MODE_IT_FALLING;
                break;

            case GPIO_STM32L496VGT6P_Mode_Event:
                Instance->Context->InitType.Mode = GPIO_MODE_EVT_RISING_FALLING;
                break;

            case GPIO_STM32L496VGT6P_Mode_EventRising:
                Instance->Context->InitType.Mode = GPIO_MODE_EVT_RISING;
                break;

            case GPIO_STM32L496VGT6P_Mode_EventFalling:
                Instance->Context->InitType.Mode = GPIO_MODE_EVT_FALLING;
                break;

            case GPIO_STM32L496VGT6P_Mode_Alternate:
                Instance->Context->InitType.Mode = GPIO_MODE_AF_PP;
                break;

            case GPIO_STM32L496VGT6P_Mode_AlternateOpenDrain:
                Instance->Context->InitType.Mode = GPIO_MODE_AF_OD;
                break;

            case GPIO_STM32L496VGT6P_Mode_Analog:
                Instance->Context->InitType.Mode = GPIO_MODE_ANALOG;
                break;

            case GPIO_STM32L496VGT6P_Mode_AnalogADC:
                Instance->Context->InitType.Mode = GPIO_MODE_ANALOG_ADC_CONTROL;
                break;
    ...
    do
    {
        ...
        switch ( Pull )
        {
            case GPIO_STM32L496VGT6P_Pull_None:
                Instance->Context->InitType.Pull = GPIO_NOPULL;
                break;

            case GPIO_STM32L496VGT6P_Pull_Up:
                Instance->Context->InitType.Pull = GPIO_PULLUP;
                break;

            case GPIO_STM32L496VGT6P_Pull_Down:
                Instance->Context->InitType.Pull = GPIO_PULLDOWN;
                break;
    ...
    do
    {
        ...
        switch ( Speed )
        {
            case GPIO_STM32L496VGT6P_Speed_Low:
                Instance->Context->InitType.Speed = GPIO_SPEED_FREQ_LOW;
                break;

            case GPIO_STM32L496VGT6P_Speed_Medium:
                Instance->Context->InitType.Speed = GPIO_SPEED_FREQ_MEDIUM;
                break;

            case GPIO_STM32L496VGT6P_Speed_High:
                Instance->Context->InitType.Speed = GPIO_SPEED_FREQ_HIGH;
                break;

            case GPIO_STM32L496VGT6P_Speed_VeryHigh:
                Instance->Context->InitType.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
                break;
...
static GPIO_STM32L496VGT6P_Status_t GPIO_STM32L496VGT6P_Instance_SetFunction( GPIO_STM32L496VGT6P_Instance_t * Instance, GPIO_STM32L496VGT6P_Function_t Function )
{
    ...
    do
    {
        ...
        Instance->Context->InitType.Alternate = Function;
    }
    while ( 0 );
...
static GPIO_STM32L496VGT6P_Status_t GPIO_STM32L496VGT6P_Instance_Commit( GPIO_STM32L496VGT6P_Instance_t * Instance )
{
    ...
    do
    {
        ...
        if ( Instance->Context->GPIOx != NULL )
        {
            HAL_GPIO_Init( Instance->Context->GPIOx, &Instance->Context->InitType );
        }
    ...
    do
    {
        ...
        switch ( Instance->GPIOx )
        {
            ...
            case GPIO_STM32L496VGT6P_5:
                ...
                Context->GPIOx = GPIOE;
                Context->InitType.Pin = GPIO_PIN_2 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_1 );
                break;
            ...
            case GPIO_STM32L496VGT6P_7:
                ...
                Context->GPIOx = GPIOC;
                Context->InitType.Pin = GPIO_PIN_13 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_7 );
                break;
            ...
            case GPIO_STM32L496VGT6P_18:
                __HAL_RCC_GPIOC_CLK_ENABLE( );
                Context->GPIOx = GPIOC;
                Context->InitType.Pin = GPIO_PIN_0 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_15 );
                break;
            ...
            case GPIO_STM32L496VGT6P_26:
                ...
                Context->GPIOx = GPIOA;
                Context->InitType.Pin = GPIO_PIN_0 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_23 );
                break;
            ...
            case GPIO_STM32L496VGT6P_32:
                __HAL_RCC_GPIOA_CLK_ENABLE( );
                Context->GPIOx = GPIOA;
                Context->InitType.Pin = GPIO_PIN_4 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_29 );
                break;
            ...
            case GPIO_STM32L496VGT6P_34:
                __HAL_RCC_GPIOC_CLK_ENABLE( );
                Context->GPIOx = GPIOC;
                Context->InitType.Pin = GPIO_PIN_4 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_33 );
                break;
            ...
            case GPIO_STM32L496VGT6P_37:
                ...
                Context->GPIOx = GPIOB;
                Context->InitType.Pin = GPIO_PIN_0 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_35 );
                break;
            ...
            case GPIO_STM32L496VGT6P_46:
                __HAL_RCC_GPIOE_CLK_ENABLE( );
                Context->GPIOx = GPIOE;
                Context->InitType.Pin = GPIO_PIN_7 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_38 );
                break;

            case GPIO_STM32L496VGT6P_47:
                __HAL_RCC_GPIOB_CLK_ENABLE( );
                Context->GPIOx = GPIOB;
                Context->InitType.Pin = GPIO_PIN_10 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_47 );
                break;
            ...
            case GPIO_STM32L496VGT6P_54:
                __HAL_RCC_GPIOB_CLK_ENABLE( );
                Context->GPIOx = GPIOB;
                Context->InitType.Pin = GPIO_PIN_12 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_51 );
                break;
            ...
            case GPIO_STM32L496VGT6P_62:
                ...
                Context->GPIOx = GPIOD;
                Context->InitType.Pin = GPIO_PIN_8 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_55 );
                break;
            ...
            case GPIO_STM32L496VGT6P_66:
                __HAL_RCC_GPIOC_CLK_ENABLE( );
                Context->GPIOx = GPIOC;
                Context->InitType.Pin = GPIO_PIN_6 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_63 );
                break;
            ...
            case GPIO_STM32L496VGT6P_69:
                __HAL_RCC_GPIOA_CLK_ENABLE( );
                Context->GPIOx = GPIOA;
                Context->InitType.Pin = GPIO_PIN_8 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_67 );
                break;
            ...
            case GPIO_STM32L496VGT6P_77:
                __HAL_RCC_GPIOA_CLK_ENABLE( );
                Context->GPIOx = GPIOA;
                Context->InitType.Pin = GPIO_PIN_15 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_77 );
                break;
            ...
            case GPIO_STM32L496VGT6P_80:
                __HAL_RCC_GPIOC_CLK_ENABLE( );
                Context->GPIOx = GPIOC;
                Context->InitType.Pin = GPIO_PIN_10 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_78 );
                break;
            ...
            case GPIO_STM32L496VGT6P_88:
                __HAL_RCC_GPIOD_CLK_ENABLE( );
                Context->GPIOx = GPIOD;
                Context->InitType.Pin = GPIO_PIN_0 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_81 );
                break;
            ...
            case GPIO_STM32L496VGT6P_93:
                __HAL_RCC_GPIOB_CLK_ENABLE( );
                Context->GPIOx = GPIOB;
                Context->InitType.Pin = GPIO_PIN_3 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_89 );
                break;
            ...
            case GPIO_STM32L496VGT6P_96:
                __HAL_RCC_GPIOB_CLK_ENABLE( );
                Context->GPIOx = GPIOB;
                Context->InitType.Pin = GPIO_PIN_8 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_95 );
                break;

            case GPIO_STM32L496VGT6P_97:
                __HAL_RCC_GPIOE_CLK_ENABLE( );
                Context->GPIOx = GPIOE;
                Context->InitType.Pin = GPIO_PIN_0 << ( Instance->GPIOx - GPIO_STM32L496VGT6P_97 );
                break;
...
static GPIO_STM32L496VGT6P_Status_t GPIO_STM32L496VGT6P_Instance_Cycle( GPIO_STM32L496VGT6P_Instance_t * Instance )
{
    ...
    do
    {
        ...
        if ( ( Instance->Context->Event & GPIO_STM32L496VGT6P_Event_ExternalInterrupt ) != 0 )
        {
            Instance->Context->Event &= ~GPIO_STM32L496VGT6P_Event_ExternalInterrupt;
...
const char GPIO_STM32L496VGT6P_VERSION[] = "0.0.0.v20260117-1036";
